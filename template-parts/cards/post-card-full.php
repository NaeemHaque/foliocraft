...
<a class="post" href="<?php the_permalink(); ?>">
	<div class="pmeta"><span class="cat"><?php echo esc_html( $cat ); ?></span><span>·</span><span><?php /* translators: %d minutes */ echo esc_html( sprintf( __( '%d min read', 'foliocraft' ), $mins ) ); ?></span></div>
	<h3><?php the_title(); ?></h3>

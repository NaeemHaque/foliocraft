	...
	<div class="wrap">
		...
		<div class="skill-grid">
			...
			<div class="skill-group" data-reveal data-delay="<?php echo (int) ( $i + 1 ); ?>">
				<div class="gh"><div class="ico"><?php echo $group_icons[ $i ]; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- trusted static SVG ?></div><h3><?php echo esc_html( $group['label'] ); ?></h3></div>

...
<?php
$contact = isset( $profile['contact'] ) ? $profile['contact'] : \Naeem\Models\Profile::all()['contact'];
$social  = isset( $profile['social'] ) ? $profile['social'] : \Naeem\Models\Profile::all()['social'];
?>
<!-- ============ CONTACT ============ -->
      ...
      <div class="contact-left" data-reveal data-delay="1">
        ...
        <div class="contact-channels">
          ...
          <a class="channel" href="<?php echo esc_url( 'mailto:' . $social['email'] ); ?>">
            ...
            <span class="ct"><span class="l"><?php esc_html_e( 'Email', 'naeem-portfolio' ); ?></span><span class="v"><?php echo esc_html( $social['email'] ); ?></span></span>

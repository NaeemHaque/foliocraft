...
<section class="section contact" id="contact">
  <div class="wrap">
    <p class="eyebrow" data-reveal><span class="num">07 /</span> <?php esc_html_e( 'Contact', 'naeem-portfolio' ); ?></p>
    <div class="contact-grid">
      <div class="contact-left" data-reveal data-delay="1">
        <h2 class="section-title"><?php esc_html_e( 'Let\'s build something.', 'naeem-portfolio' ); ?></h2>
        <p class="section-lead"><?php esc_html_e( 'Open to interesting open-source collaborations and product engineering work. The fastest way to reach me is the form — or any of these:', 'naeem-portfolio' ); ?></p>
        <div class="contact-channels">
          <span class="ch-label"><?php esc_html_e( 'Direct lines', 'naeem-portfolio' ); ?></span>
          <a class="channel" href="<?php echo esc_url( 'mailto:hello@naeem.dev' ); ?>">
            ...
            <span class="ct"><span class="l"><?php esc_html_e( 'Email', 'naeem-portfolio' ); ?></span><span class="v">hello@naeem.dev</span></span>
          ...
          <a class="channel" href="<?php echo esc_url( 'https://github.com/naeemHaque' ); ?>" target="_blank" rel="noopener">
            ...
            <span class="ct"><span class="l"><?php esc_html_e( 'GitHub', 'naeem-portfolio' ); ?></span><span class="v">github.com/naeemHaque</span></span>
            <span class="arrow"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M9 7h8v8"/></svg></span>
          </a>
          <a class="channel" href="<?php echo esc_url( 'https://linkedin.com/in/golam-sarwer-8626101a3' ); ?>" target="_blank" rel="noopener">
            ...
            <span class="ct"><span class="l"><?php esc_html_e( 'LinkedIn', 'naeem-portfolio' ); ?></span><span class="v">in/golam-sarwer</span></span>
            <span class="arrow"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M9 7h8v8"/></svg></span>
          </a>
        </div>
      </div>
      ...
      <form class="form" id="contactForm" novalidate data-reveal data-delay="2">
        ...
        <div class="field" id="f-name">
          <label for="name"><?php esc_html_e( 'Name', 'naeem-portfolio' ); ?> <span class="req">*</span></label>
          <input type="text" id="name" name="name" placeholder="<?php esc_attr_e( 'Your name', 'naeem-portfolio' ); ?>" autocomplete="name" />
          <span class="err"><?php esc_html_e( 'Please enter your name.', 'naeem-portfolio' ); ?></span>
        </div>
        <div class="field" id="f-email">
          <label for="email"><?php esc_html_e( 'Email', 'naeem-portfolio' ); ?> <span class="req">*</span></label>
          <input type="email" id="email" name="email" placeholder="<?php esc_attr_e( 'you@company.com', 'naeem-portfolio' ); ?>" autocomplete="email" />
          <span class="err"><?php esc_html_e( 'Please enter a valid email.', 'naeem-portfolio' ); ?></span>
        </div>
        <div class="field" id="f-message">
          <label for="message"><?php esc_html_e( 'Message', 'naeem-portfolio' ); ?> <span class="req">*</span></label>
          <textarea id="message" name="message" placeholder="<?php esc_attr_e( 'What are you building?', 'naeem-portfolio' ); ?>"></textarea>
          <span class="err"><?php esc_html_e( 'A little more detail, please (10+ characters).', 'naeem-portfolio' ); ?></span>
        </div>
        <div class="form-foot">

      ...
      <div class="contact-left" data-reveal data-delay="1">
        ...
        <div class="contact-channels">
          ...
          <a class="channel" href="<?php echo esc_url( $social['github'] ); ?>" target="_blank" rel="noopener">
            ...
            <span class="arrow"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M9 7h8v8"/></svg></span><?php foliocraft_new_tab(); ?>
          </a>
          <?php endif; ?>
